    ...
    public partial class AddRowVersionToSeat : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2026, 5, 31, 17, 43, 48, 160, DateTimeKind.Local).AddTicks(6298), "Gran evento", "Activo", "Estadio A" });

            migrationBuilder.InsertData(
                table: "USER",
                columns: new[] { "Id", "Email", "Name", "PasswordHash" },
                values: new object[] { 1, "Proyecto2026@gmail.com", "Proyecto", "$2a$11$rkr4ziWHtoqKpNch7Ux04ePBh2KE9eghuP8N71lfGF/CM7qYklYKy" });
